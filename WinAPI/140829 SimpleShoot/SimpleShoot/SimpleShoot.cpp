// SimpleShoot.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SIMPLESHOOT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SIMPLESHOOT));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_SIMPLESHOOT);
