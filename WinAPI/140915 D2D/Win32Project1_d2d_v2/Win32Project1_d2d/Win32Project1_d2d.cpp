                     ...
                     _In_ int       nCmdShow)
{
	...
	g_pMainGame->LoadImages(g_d2dRender,g_hWnd);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		break;
	case WM_TIMER:
		if (g_pMainGame != nullptr)
		{
			g_pMainGame->Update(50 / 1000.0f);
	...
	case WM_PAINT:
	{
			...
			if (g_pMainGame != nullptr)
				g_pMainGame->Render(g_d2dRender);
