...
typedef struct TileMap{
	...
	int tilew;		// width of the tile
	int tileh;		// height of the tile
	int top;		// x coordinate of the lefttop
	int left;		// y coordinate of the lefttop
	int right;		// x coordinate of the rightbottom
	int bottom;		// y coordinate of the rightbottom
}TILEMAP, *LPTILEMAP;
